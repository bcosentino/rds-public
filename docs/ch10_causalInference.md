...
<img src="ch10_causalInference_files/figure-html/c4c1-1.png" alt="Initial DAG for the causal effect of greenspace on mental health." width="288" />
<p class="caption">(\#fig:c4c1)Initial DAG for the causal effect of greenspace on mental health.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c4c2-1.png" alt="DAG with the confounding variable SES added." width="288" />
<p class="caption">(\#fig:c4c2)DAG with the confounding variable SES added.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c4c11-1.png" alt="DAG for effects of sunscreen use and sun exposure on skin cancer risk." width="288" />
<p class="caption">(\#fig:c4c11)DAG for effects of sunscreen use and sun exposure on skin cancer risk.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c4c12-1.png" alt="DAG for causal effect of exercise on recovery time from a respiratory virus." width="288" />
<p class="caption">(\#fig:c4c12)DAG for causal effect of exercise on recovery time from a respiratory virus.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c4c13-1.png" alt="DAG for causal effect of forest area and fragmentation on bird diversity." width="288" />
<p class="caption">(\#fig:c4c13)DAG for causal effect of forest area and fragmentation on bird diversity.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c4c14-1.png" alt="DAG for the causal effect of serious illness on COVID infection status." width="288" />
<p class="caption">(\#fig:c4c14)DAG for the causal effect of serious illness on COVID infection status.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c4c17-1.png" alt="DAG for the causal effect of screen time on obesity in pediatric patients." width="480" />
<p class="caption">(\#fig:c4c17)DAG for the causal effect of screen time on obesity in pediatric patients.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c5c1-1.png" alt="DAG for the causal effect of screen time on obesity in pediatric patients." width="480" />
<p class="caption">(\#fig:c5c1)DAG for the causal effect of screen time on obesity in pediatric patients.</p>
</div>
...
The `sample` function was used to randomly assign each of the 200 participants to one of the three treatment levels [^ch05-1]. Here's why randomization is the key feature of an experiment: If the treatment levels are randomly assigned to each individual, then there will be no relationship between the screen time of each participant and their parent's education level. A participant with who has highly educated parents will have an equal chance of being assigned to each of the three levels of screen time. In other words, experiments remove the influence of confounding variables on the explanatory variable. If the researcher used an experiment in this way, the DAG would be revised to eliminate the $Parent.education \to Screen.time$ effect as seen in Figure \@ref(fig:c5c3).

[^ch05-1]: The `replace` = TRUE argument just means that the sampling is done "with replacement". That means if the first person is assigned the "high" treatment, the next person can also be assigned the "high" treatment.

<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c5c3-1.png" alt="DAG for the causal effect of screen time on obesity in pediatric patients when using an experimental study design." width="480" />
<p class="caption">(\#fig:c5c3)DAG for the causal effect of screen time on obesity in pediatric patients when using an experimental study design.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="ch10_causalInference_files/figure-html/c5c4-1.png" alt="Revised DAG including actual screen time." width="672" />
<p class="caption">(\#fig:c5c4)Revised DAG including actual screen time.</p>
</div>
