...
\caption{Initial DAG for the causal effect of greenspace on mental health.}(\#fig:c10c01)
\end{figure}
...
\caption{DAG with the confounding variable SES added.}(\#fig:c10c02)
\end{figure}
...
\caption{DAG for effects of sunscreen use and sun exposure on skin cancer risk.}(\#fig:c10c11)
\end{figure}
...
\caption{DAG for causal effect of exercise on recovery time from a respiratory virus.}(\#fig:c10c12)
\end{figure}
...
\caption{DAG for causal effect of forest area and fragmentation on bird diversity.}(\#fig:c10c13)
\end{figure}
...
\caption{DAG for the causal effect of serious illness on COVID infection status.}(\#fig:c10c014)
\end{figure}
...
\caption{DAG for the causal effect of screen time on obesity in pediatric patients.}(\#fig:c10c17)
\end{figure}
...
\caption{DAG for the causal effect of screen time on obesity in pediatric patients.}(\#fig:c10c18)
\end{figure}
...
\caption{DAG for the causal effect of screen time on obesity in pediatric patients when using an experimental study design.}(\#fig:c10c20)
\end{figure}
...
\caption{Revised DAG including actual screen time.}(\#fig:c10c21)
\end{figure}
